...
{
    //Step 1 - Write first piece of data to first location
    StartI2C1(); //begin I2C connection
    WriteI2C1(0xA0); //control
    WriteI2C1(0x00); //MSB of address
    WriteI2C1(EEPROMaddress1); //LSB of address
    WriteI2C1(VALUE1); //write buffer value to EEPROM memory and increment pointer
    StopI2C1(); //stop I2C connection
    ...
    //Step 3 - Write second piece of data to second location
    StartI2C1(); //begin I2C connection
    WriteI2C1(0xA0); //control
    WriteI2C1(0x00); //MSB of address
    WriteI2C1(EEPROMaddress2); //LSB of address
    WriteI2C1(VALUE2); //write buffer value to EEPROM memory and increment pointer
    StopI2C1(); //stop I2C connection
}
